...
void carmen_logwrite_write_header(carmen_FILE *outfile)
{
  ...
  carmen_fprintf(outfile, "# SMARTSTATUS gas_pos gear steering_angle tv rv_front_right rv_front_left rv_rear_right rv_rear_left\n");
  carmen_fprintf(outfile, "# GYROINT theta\n");
...
void carmen_logwrite_write_odometry(carmen_base_odometry_message *odometry, 
				    ...
				    double timestamp)
{
  carmen_fprintf(outfile, "ODOM %f %f %f %f %f %f %lf %s %lf\n", odometry->x,
				   ...
				   carmen_FILE *outfile, double timestamp)
{
  ...
  carmen_fprintf(outfile, "TRUEPOS %f %f %f %f %f %f %lf %s %lf\n", 
...
void carmen_logwrite_write_param(char *module, char *variable, char *value, 
				 ...
				 carmen_FILE *outfile, double timestamp)
{
  carmen_fprintf(outfile, "PARAM %s_%s %s %f %s %lf\n", module, 
...
void carmen_logwrite_write_sync(carmen_logger_sync_message *sync_message, 
				carmen_FILE *outfile)
{
  carmen_fprintf(outfile, "SYNC %s %f %s %lf\n", sync_message->tag,
...
void carmen_logwrite_write_gps_gpgga(carmen_gps_gpgga_message *gps_msg, 
				  carmen_FILE *outfile, double timestamp)
{
...
void carmen_logwrite_write_gps_gprmc(carmen_gps_gprmc_message *gps_msg, 
				  carmen_FILE *outfile, double timestamp)
{
  char lat_o  = gps_msg->lat_orient;
  char long_o = gps_msg->long_orient;
...
void carmen_logwrite_write_smart_status(smart_status_message *msg,  
  carmen_FILE *outfile, double timestamp) {
  carmen_fprintf(outfile, "SMARTSTATUS %f %d %f %f %f %f %f %f %lf %s %lf\n",
    msg->gas_pos, msg->gear, msg->steering_angle, msg->tv,
    msg->rv_front_right, msg->rv_front_left, msg->rv_rear_right, 
    msg->rv_rear_left, msg->timestamp, msg->host, timestamp);
}

void carmen_logwrite_write_gyro_integrated(gyro_integrated_message *msg, 
  carmen_FILE *outfile, double timestamp) {
  carmen_fprintf(outfile, "GYROINT %lf %lf %s %lf\n",
